    ...
    void seat_reserve() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("다시 선택하십시오. (1 ~ 3)");
                continue;
            }
            ...
            if (seat_Number > 10 || seat_Number < 1) {
                System.out.println("E: 잘못 입력하셨습니다. (1 ~ 10).");
                continue;
            }
            // 이미 예약된 좌석 거르기
            if (!this.seats[seat - 1][seat_Number - 1].equals("---")) {
                System.out.println("E: 이미 예약된 좌석입니다.");
                continue;
            }
            ...
            try {
                ...
                System.out.println("E: 다시 선택하십시오. (1 ~ 10)");
                continue;
            }
...
public class concert_reservation {
	public static void main(String[] args) {
		reserveSystem sr = new reserveSystem(); // ShowReserve 객체 생성
        Scanner scanner = new Scanner(System.in);
        int select;
